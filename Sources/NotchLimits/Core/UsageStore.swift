...
final class UsageStore: ObservableObject {
    ...
    /// Все обнаруженные аккаунты — чтобы отличить незавершённые профили
    /// (папка есть, входа нет) от уже подключённых.
    var discoveredAccounts: [DiscoveredAccount] { accounts }
